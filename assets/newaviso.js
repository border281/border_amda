...
{
     $.post("http://amda.gsinlimites.com.mx/index.php/distribuidor/addmodificatorio", {
...
function actualizar_beneficiario()
{
 ...
 {
    window.location="http://amda.gsinlimites.com.mx/index.php/operaciones/";
 } 
 
 function fin(){alert("hola mundo");}